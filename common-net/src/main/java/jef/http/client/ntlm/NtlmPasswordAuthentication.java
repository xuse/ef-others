 ...
 */
    static public byte[] getPreNTLMResponse( String password, byte[] challenge ) {
        ...
        byte[] passwordBytes;
        try {
            passwordBytes = password.toUpperCase().getBytes( Config.DEFAULT_OEM_ENCODING);
 ...
 */
    ...
    public byte[] getSigningKey(byte[] challenge) throws JefException
    {
        switch (LM_COMPATIBILITY) {
            case 0:
            case 1:
            ...
            case 5:
                 ...
                 */
                throw new JefException("NTLMv2 requires extended security (jcifs.smb.client.useExtendedSecurity must be true if jcifs.smb.lmCompatibility >= 3)");
        }
        return null;
    }
     ...
     */
    void getUserSessionKey(byte[] challenge, byte[] dest, int offset) throws JefException {
