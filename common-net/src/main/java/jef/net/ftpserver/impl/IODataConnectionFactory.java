...
public class IODataConnectionFactory implements ServerDataConnectionFactory {
     ...
     * (non-Javadoc)
     *
     * @see jef.net.ftpserver.FtpDataConnectionFactory2#getInetAddress()
     */
     ...
     * (non-Javadoc)
     *
     * @see jef.net.ftpserver.FtpDataConnectionFactory2#getPort()
     */
    public int getPort() {
        return port;
    }
     ...
     * (non-Javadoc)
     *
     * @see jef.net.ftpserver.FtpDataConnectionFactory2#openConnection()
     */
     ...
     * (non-Javadoc)
     *
     * @see jef.net.ftpserver.DataConnectionFactory#isSecure()
     */
     ...
     * (non-Javadoc)
     *
     * @see jef.net.ftpserver.DataConnectionFactory#isZipMode()
     */
