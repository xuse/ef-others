...
public class SITE extends AbstractCommand {
    ...
    static {
        COMMAND_MAP.put("SITE_DESCUSER",
                new jef.net.ftpserver.command.impl.SITE_DESCUSER());
        COMMAND_MAP.put("SITE_HELP",
                new jef.net.ftpserver.command.impl.SITE_HELP());
        COMMAND_MAP.put("SITE_STAT",
                new jef.net.ftpserver.command.impl.SITE_STAT());
        COMMAND_MAP
                .put("SITE_WHO", new jef.net.ftpserver.command.impl.SITE_WHO());
        COMMAND_MAP.put("SITE_ZONE",
                new jef.net.ftpserver.command.impl.SITE_ZONE());
    }
}
