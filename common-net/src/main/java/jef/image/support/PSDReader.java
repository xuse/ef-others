...
public class PSDReader {
	...
	/**
	 * Gets the image contents of frame n. Note that this expands the image to
	 * the full frame size (if the layer was smaller) and any subsequent use of
	 ...
	 * use getFrameOffset() to obtain position of subimage within main image
	 * area.
	 * 
