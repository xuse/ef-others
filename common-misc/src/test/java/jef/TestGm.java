...
public class TestGm {
	...
	public static void main(String[] args) throws Exception {
	    ...
	    System.out.println("原图片大小:" + imageUtil.getSize("e://10.19.133.104bgImgUrl.jpg") + "Bit");
	    System.out.println("原图片宽度:" + imageUtil.getWidth("e://10.19.133.104bgImgUrl.jpg"));
	    System.out.println("原图片高度:" + imageUtil.getHeight("e://10.19.133.104bgImgUrl.jpg"));
	    if (imageUtil.zoomImage("e://10.19.133.104bgImgUrl.jpg", "e://test1.jpg", 500, null)) {
	        if (imageUtil.rotate("e://test1.jpg", "e://test2.jpg", 15)) {
