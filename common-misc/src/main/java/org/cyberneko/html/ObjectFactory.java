 ...
 * <p>
 * 
 * @version $Id: ObjectFactory.java 219322 2012-10-18 12:38:37Z shiym $
 */
class ObjectFactory {
	...
	/***************************************************************************
	 * Cache the time stamp of the xerces.properties file so that we know if
	 * it's been modified and can invalidate the cache when necessary.
	 */
	 ...
	 *            file. If none specified, ${java.home}/lib/xerces.properties
	 *            will be used.
	 * @param fallbackClassName
	 *            Implementation class name, if nothing else is found. Use null
	 *            to mean no fallback.
	...
	static class ConfigurationError extends Error {
		private static final long serialVersionUID = -833749646709453237L;
		//
		// Data
		//
		/** Exception. */
