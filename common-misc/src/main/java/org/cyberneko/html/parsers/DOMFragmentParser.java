 ...
 * @author Andy Clark
 *
 * @version $Id: DOMFragmentParser.java 219322 2012-10-18 12:38:37Z shiym $
 */
public class DOMFragmentParser
    implements XMLDocumentHandler,jef.tools.IDOMFragmentParser {
    ...
    public void startElement(QName element, XMLAttributes attrs,
        ...
        for (int i = 0; i < count; i++) {
            ...
            if(StringUtils.isNumericSpace(aname)){
            	//非法属性，容错并警告 Jiyi 2009-11-03
            	System.out.print("Warnning: \""+aname +"\" is a invalid property name in HTML." );
            }else{
