...
public class CheckNodeTreeExample extends JFrame {
	...
	public CheckNodeTreeExample() {
		...
		//tree.setFont(new Font("Tahoma",0,14));
...
class CheckRenderer extends JPanel implements TreeCellRenderer {
	 ...
	 * @Fields serialVersionUID : TODO(用一句话描述这个变量表示什么)
	 */
	private static final long serialVersionUID = 3954821375816011529L;
	...
	public class TreeLabel extends JLabel {
		private static final long serialVersionUID = -2635617715604690331L;
